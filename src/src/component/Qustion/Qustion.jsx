          ...
          <div className="lg:flex gap-4 bg-slate-300 py-4">
            <div className="bg-slate-50 rounded px-5 py-6 lg:w-4/6 border-s-2 border-s-red-600 h-full">
              <div className="flex gap-3 mb-3">
                <div>
                  <img className="rounded-full" src={question.user.userimage} alt="man" width={30} height={30} />
                </div>
                <div>
                  <a className="text-pink-500 font-bold hover:text-slate-600" href="">
                ...
                <div>
                  <p>Asked: <a className="text-slate-600 hover:text-slate-900" href="">
                    {question.date}
                  </a></p>
                </div>
                <div>
              ...
              <Link to={`/qustionAnswer/${question.id}`}>
              ...
              <div className="lg:flex justify-between items-center gap-3 mt-5">
                <div className="flex gap-3">
                  ...
                  <div className="ms-2 flex items-center">
                    ...
                    <a className="text-slate-50 bg-red-200 rounded-full" size={20}/>
