    ...
    <>
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content">
          ...
          <label
            htmlFor="my-drawer-2"
            className="btn btn-primary fixed left-0 top-20 drawer-button lg:hidden"
          >
            Profile
          </label>
        </div>
        <div className="drawer-side pt-16 md:pt-0 lg:pt-0">
          ...
          <div className="py-4  w-64 min-h-full bg-slate-300 text-base-content">
            ...
            <div className="text-center">
              ...
              <div>
                <h2 className="text-[1.3rem] secondary-text font-[Sans]">
                  {user.displayName}
                </h2>
            ...
            <div className="py-2">
              <ul className="ml-2 my-2 text-[1.2rem] secondary-text font-[Sans]">
                <li className="bg-slate-400 px-5 rounded-l-full my-2 hover:bg-gray-500 transition-all hover:scale-110 hover:ml-16">
                  <a>Posts</a>
                </li>
                <li className="bg-slate-400 px-5 rounded-l-full my-2 hover:bg-gray-500 transition-all hover:scale-110 hover:ml-10">
                  <a>Comments</a>
                </li>
              </ul>
            </div>
