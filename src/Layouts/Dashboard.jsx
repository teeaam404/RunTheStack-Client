...
const Dashboard = () => {
  ...
  return (
    <div className="mb-8">
      <img
        src="https://i.ibb.co/6NZLzbY/pexels-kelly-2876511.jpg"
          ...
          <div className="border-2 lg:w-[30%] mx-auto text-center">
            <div className="avatar mt-4">
              <div className="w-24 rounded-full">
                <img
                  src="https://i.ibb.co/Myz29tn/pexels-pixabay-415829.jpg "
                  alt="Avatar"
                />
              </div>
            </div>
            ...
            <p className="text-sm lg:px-4">
              A passionate specialist at couples therapy with over 10 years of
              experience
            </p>
            ...
            <div className="py-4">
              <div className="bg-slate-50 rounded px-5 py-6 lg:w-full border-2 border-s-2 border-s-red-600 h-full">
                ...
                <p className="mt-3 mb-3">
                  The entire DC Universe is out to assassinate you. What five
                  Marvel characters do you choose to ensure your safety and why?
                  The entire DC Universe? OK, I’m going to need some heavy
                  hitters here.
                </p>
