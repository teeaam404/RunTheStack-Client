            ...
            <div className='text-center my-5'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 justify-between gap-10 my-5'>
                    ...
                    <div>
                        ...
                        <p className='common-text'><small> Don't have an account</small> <Link to="/registration"><button className='secondary-text primary-bg p-1 rounded-md'>Registration</button></Link> </p>
                        {/* Social login */}
