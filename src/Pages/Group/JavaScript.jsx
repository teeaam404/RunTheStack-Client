    ...
    return (
        <div className=''>
            <div className="flex py-2 gap-2">
                <img className="w-2/6 h-[160px] ps-2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3wozi7VHv9bcG3ku_8zyQj0TUgluhIPInrA&usqp=CAU" alt="" />
                <div className=" w-4/6 border-[2px] ps-4 shadow-xl pt-4 pe-2">
                    <h2 className="text-2xl font-bold text-pink-600">JavaScript Learner</h2>
