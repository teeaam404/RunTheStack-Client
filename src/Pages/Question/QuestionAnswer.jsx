...
const QuestionAnswer = () => {
  ...
  return (
    <div className="secondary-bg px-10">
      {questionAnswer && (
        <div className=" py-5">
          <div className="border-s-2 border-s-emerald-400 lg:w-4/6 bg-slate-50">
              ...
              <div className="flex gap-3">
                ...
                <div className="">
                  <div className="flex gap-2 mb-auto">
                    ...
                    <span className="bg-blue-400 px-1 rounded text-white text-sm">
                      Professional
                    </span>
                    <p>Makeup Artist</p>
                  </div>
                  <div>
                    <a
                      ...
                      href=""
                    >
                      Added an answer on January 4, 2022 at 4:32 pm
                    </a>
                  </div>
                </div>
              </div>
              <div>
                <p className="text-white bg-emerald-400 px-2 rounded">
                  Best Answer
                </p>
              </div>
            </div>
            ...
            <div className="text-gray-500 px-7 font-semibold">
              <p>
                Best thing about Hulk is that more angrier he gets, more
                stronger he becomes. His anger did take him to a point where his
                stomp was enough to crack an entire land, and only Sentry was
                able to stop Hulk from this (Planet Hulk/World War Hulk
                storyline). Hulk has unlimited strength and accelerated healing
                factor, and doesn’t get tired easily or return back to his Bruce
                Banner form (because Hulk and Banner are two separate
                personalities stuck in a same body), and I guess Hulk would be
                enough to break bones of plenty of DC characters.
              </p>
            </div>
            ...
            <div className="p-7 flex gap-4">
              ...
              <div className="flex ml-3">
                <GiEternalLove
                  className="text-slate-50 bg-red-400 rounded-full"
                  size={20}
                />
                <FcLike
